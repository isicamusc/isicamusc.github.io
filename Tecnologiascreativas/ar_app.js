...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/pattern-ICC.patt',
    });
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('grass.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('grass.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('maceta.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('maceta.obj', function (group) {
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('tallo.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('tallo.obj', function (group) {
                RhinoMesh2 = group.children[0];
                RhinoMesh2.material.side = THREE.DoubleSide;
                RhinoMesh2.scale.set(0.08, 0.08, 0.08);
                RhinoMesh2.castShadow = true;
     ...
     new THREE.MTLLoader()
     .setPath('data/models/')
     .load('centro.mtl', function (materials) {
         materials.preload();
         new THREE.OBJLoader()
             .setMaterials(materials)
             .setPath('data/models/')
             .load('centro.obj', function (group) {
                 RhinoMesh2 = group.children[0];
                 RhinoMesh2.material.side = THREE.DoubleSide;
                 RhinoMesh2.scale.set(0.08, 0.08, 0.08);
                 RhinoMesh2.castShadow = true;
     ...
     new THREE.MTLLoader()
     .setPath('data/models/')
     .load('eye1.mtl', function (materials) {
         materials.preload();
         new THREE.OBJLoader()
             .setMaterials(materials)
             .setPath('data/models/')
             .load('eye1.obj', function (group) {
                 RhinoMesh2 = group.children[0];
                 RhinoMesh2.material.side = THREE.DoubleSide;
                 RhinoMesh2.scale.set(0.08, 0.08, 0.08);
                 RhinoMesh2.castShadow = true;
